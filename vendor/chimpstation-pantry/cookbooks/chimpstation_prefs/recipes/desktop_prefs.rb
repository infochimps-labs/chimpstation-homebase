...
osx_defaults "com.apple.dock", "no-glass" do
  value         node[:osx_prefs][:dock][:no_glass]
  notifies      :restart, dock, :delayed
end

osx_defaults "com.apple.dock", "orientation" do
  value         node[:osx_prefs][:dock][:orientation]
  notifies      :restart, dock, :delayed
end

osx_defaults "com.apple.dock", "autohide" do
  value         node[:osx_prefs][:dock][:autohide]
  notifies      :restart, dock, :delayed
end
